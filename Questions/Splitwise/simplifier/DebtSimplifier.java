package Questions.Splitwise.simplifier;
import java.util.*;


public class DebtSimplifier {

    public static Map<String, Map<String, Double>> simplifyDebts(Map<String, Map<String, Double>> groupBalances) {
        
        // Har user ka final balance nikalna
